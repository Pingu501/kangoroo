var quotes = {
    "0": {
        "quote": "I don’t really have no ambition you know. I only have one thing I’d really like to see happen. I’d like to see Mankind live together. Black, white, Chinese, everyone. That’s all.",
        "author": "Donald Trump",
        "original": "Bob Marley"
    },
    "1": {
        "quote": "Niemand hat die Absicht eine Mauer zu bauen!",
        "author": "Donald Trump",
    ...
    "9": {
        ...
        "author": "H.P. Baxxter",
        "original": "Rainer Maria Rilke (aus dem Gedicht 'Herbsttag')"
    },
    "10": {
        ...
        "original": "Kurt Tucholsky"
    },
    "11": {
        "quote": "Alles, was wir sind, ist das Resultat von dem, was wir gedacht haben",
	...
	"17": {
		"quote": "Hier bin ich Mensch, hier kauf' ich ein.",
		"author": "Friedrich Schiller",
		"original": "Werbespruch des Drogeriemarktes dm"
	},
	"18": {
		"quote": "Ein Experte ist ein Mann, der hinterher genau sagen kann, warum seine Prognose nicht gestimmt hat",
		"author": "Peter Hartz",
		"original": "Winston Churchill"
	},
	"19": {
		"quote": "Rock'n'Roll ain't noise pollution. Rock'n'Roll is just Rock'n'Roll. Yeah.",
		"author": "Walter von der Vogelweide",
		"original": "Rock 'N' Roll Ain't Noise Pollution von AC/DC"
	},
	"20": {
		"quote": "Das wird doch alles von den Medien hochsterilisiert.",
	...
	"31": {
		"quote": "Das Boot ist voll.",
		"author": "Noah, Sohn des Lamech",
		"original": "Eduard von Steiger, 30. August 1940"
	},
	"32": {
	...
	"37": {
		...
		"author": "Deutsche Hochschule der Polizei",
		"original": "Rambo 3"
	},
	"38": {
		"quote": "Dream a little dream of me.",
		"author": "Freddy Krueger",
		"original": "Song von Kahn, Andre und Schwandt, vielfach interpretiert (The Mamas and the Papas u.a.)"
	},
	"39": {
		"quote": "Ich mache nie Voraussagen und werde das auch niemals tun.",
		"author": "Nostradamus",
		"original": "Paul Gascoigne"
	},
	"40": {
		"quote": "I want you to want me. I need you to need me.",
		"author": "Angebot zur Nachfrage",
	...
	"43": {
		"quote": "Ich schaue mir meine Filme nie an. Sie sind mir zu brutal.",
	...
	"47": {
		"quote": "Der Mensch ist nichts anderes als das, wozu er sich macht.",
		"author": "Optimus Prime",
		"original": "Bertolt Brecht"
	},
	"48": {
	...
	"51": {
		"quote": "Du riechst so gut.",
		"author": "Jean-Baptiste Grenouille",
	...
	"53": {
		"quote": "Dieses Kribbeln im Bauch, das man nie mehr vergisst, als ob da im Magen der Teufel los ist.",
		"author": "Lieutenant Ellen Ripley",
		"original": "Lied von Pe Werner"
	},
	"54": {
		"quote": "Wer sich seiner Vergangenheit nicht erinnert, ist verurteilt, sie zu wiederholen.",
		"author": "Rocky Balboa",
		"original": "George Santayana"
	},
	"55": {
	...
	"57": {
		"quote": "Into exile, I must go. Failed, I have.",
		"author": "Hillary Clinton",
		"original": "Yoda"
	},
	"58": {
		"quote": "Auch wenn man unterliegt, soll man es in Ehren tun.",
		"author": "Donald Trump",
		"original": "Niccolò Machiavelli"
	},
	"59": {
		"quote": "Komm mit mir ins Abenteuerland. Der Eintritt kostet den Verstand.",
		"author": "Donald Trump",
	...
	"61": {
		"quote": "Dabei sein ist alles.",
		"author": "Xavier Naidoo",
		"original": "Grundprinzip von Olympia"
	}
};